...
def main():
    ...
    schedule = pd.read_parquet('nba_schedule_master.parquet', engine='auto', columns=None)
    ...
    for year in years_arr:
        print("Scraping NBA PBP for {}...".format(year))
        ...
        print("Finished NBA PBP for {}...".format(year))
    gc.collect()
